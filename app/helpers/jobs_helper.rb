module JobsHelper
  ...
  def category
    ["Akunting dan keuangan", "Ambassador", "Animasi", "Arsitek", "Asuransi", "Bank", "Desain",
     "Desain Grafis", "Data Entry", "Designer", "Fashion", "Film", "Fotograf","Hotel",
     "Hubungan Internasional", "IT", "Komunikasi", "Komunitas ", "Komputer",
     "Konsultan", "Keuangan", "Kesehatan", "Kapal Pesiar", "Logistik", "Marketing",
     "Media - Jurnalis", "Museum", "Marketing", "Menulis", "NGO", "Periklanan", "Farmasi",
     "Pelayanan Pelanggan", "Pendidikan", "Perencanaan Acara", "Pemerintah", "Pabrik",
     "Perencanaan Pernikahan", "Pameran dan Bazzar", "Pendidikan", "Penulis Konten ", "Programming",
     "Publisher", "Rumah Sakit", "Restoran", "Sales", "Sosial Media", "Startup",
     "Sukarelawan", "Sales dan Marketing", "Social Media Manager", "Travel"]
  end
end
