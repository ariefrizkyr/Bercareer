module ProfilesHelper
  ...
  def field
    ["Agriculture, Fisheries & Plantation", "Apparel, Textile & Fashion", "Automotive & Component",
     "Banking & Financial Services", "Beauty & Wellness", "Building Material & Sanitary",
     "Business Process Outsourcing (BPO)", "Conglomerate / Holding Company", "Consumer Electronics", "Appliance & Furnishing",
     "Education & Training", "Engineering, Procurement, Construction (EPC)",
     "Environmental & Facilities Services", "FMCG", "Food & Beverage", "Government", "Non Profit & Public Facilities",
     "Healthcare & Pharmaceutical", "Heavy Equipment & Industrial Machinery", "Hospitality, Travel & Tourism",
     "Industrial Goods & Chemical", "Insurance", "IT & Telecommunication",
     "Jewellry & Luxury Goods", "Consulting, Research & Legal Services", "Media, Entertainment & Advertising", "Mining, Oil & Gas",
     "Paper & Forestry Product", "Printing & Publishing", "Real Estate & Property", "Restaurant & Food Services",
     "Retail & Wholesale Trading", "Science & Technology", "Tobacco & Cigarettes", "Transportation & Logistic",
     "Utilities & Energy", "Other Manufacturers", "Other Services"]
  end
end
